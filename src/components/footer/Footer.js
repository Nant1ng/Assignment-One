    ...
    <div className="w-full min-h-max flex items-center justify-center bg-gray-500 mt-10">
      <div className="md:w-2/3 w-full px-4 text-white flex flex-col">
        <div className="w-full text-4xl font-bold">
          <h1 className="w-full md:w-2/3 mt-5">
            How can we help you? Get in touch
          </h1>
        </div>
        <div className="flex mt-8 flex-col md:flex-row md:justify-between">
          <p className="w-full md:w-2/3 text-teal-300">
        ...
        <div className="flex flex-col">
          <div className="flex mt-20 mb-12 flex-row justify-between">
            ...
            {/* Kanske använder de senare i framtiden 
          ...
          <p className="w-full text-center my-6 text-gray-900">
            Copyright © 2020 Nanting
          </p>
        </div>
      </div>
    </div>
