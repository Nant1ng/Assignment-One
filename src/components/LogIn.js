          ...
          <div className="relative w-full rounded-3xl  px-6 py-4 bg-gray-100 shadow-md">
            ...
            <form method="#" action="#" className="mt-10">
              ...
              <div className="flex mt-7 justify-center text-center w-full">
                <button className="bg-teal-300 border-none px-4 py-2 rounded-xl cursor-pointer text-gray-900 shadow-xl hover:shadow-inner transition duration-500 ease-in-out  transform hover:-translate-x hover:scale-105">
                  Register
                </button>
              </div>
            </form>
