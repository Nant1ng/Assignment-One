        ...
        <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
          <div className="mt-8 overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-6 mr-2 bg-gray-600 sm:rounded-lg">
                <h1 className="text-4xl sm:text-5xl text-teal-300 font-extrabold tracking-tight">
                  Get in touch
                </h1>
                <p className="text-normal text-lg sm:text-2xl font-medium text-teal-300 mt-2">
                  Fill in the form to start a conversation
                </p>

                <div className="flex items-center mt-8 text-teal-300">
                  <svg
                    fill="none"
                    stroke="currentColor"
                  ...
                  <div className="ml-4 text-md tracking-wide font-semibold w-40">
                    Nanting, Stockholm, Stockholm, 100 04
                  </div>
                </div>

                <div className="flex items-center mt-4 text-teal-300 dark:text-gray-400">
                  <svg
                    fill="none"
                    stroke="currentColor"
                    stroke-linecap="round"
                ...
                <div className="flex items-center mt-2 text-teal-300 dark:text-gray-400">
                  <svg
                    fill="none"
                    stroke="currentColor"
                    stroke-linecap="round"
